...
public class MainActivity extends Activity {
    ...
    private void compute(Calculator.Operator operator) {
        ...
        double operandTwo;
        try {
            if (!mOperandOneEditText.getText().toString().isEmpty() && !mOperandTwoEditText.getText().toString().isEmpty() ) {
                operandOne = getOperand(mOperandOneEditText);
                operandTwo = getOperand(mOperandTwoEditText);
            } else if (!mOperandOneEditText.getText().toString().isEmpty() && mOperandTwoEditText.getText().toString().isEmpty() ) {
                operandOne = getOperand(mOperandOneEditText);
                operandTwo = 0;
            } else if (mOperandOneEditText.getText().toString().isEmpty() && !mOperandTwoEditText.getText().toString().isEmpty() ) {
                operandOne = 0;
